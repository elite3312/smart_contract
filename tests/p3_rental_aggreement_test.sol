...
contract RentalAgreementManagementTest {
    ...
    function testCreateAgreement() public {
        ...
        Assert.equal(rentAmount, 1000 * 1 gwei, "Rent amount should be correct");
    ...
    function testPayRent() public {
        rentalAgreementManagement.createAgreement(landlord, tenant, 1000, 12);
        uint256 initialLandlordBalance = landlord.balance;
        rentalAgreementManagement.payRent{value: 1000 * 1 gwei}(0);
        ...
        Assert.equal(landlord.balance, initialLandlordBalance + 1000 * 1 gwei, "Landlord should receive rent");
    }
    ...
    function testGetAgreementStatus() public {
        rentalAgreementManagement.createAgreement(landlord, tenant, 1000, 12);
        string memory status = rentalAgreementManagement.getAgreementStatus(0);
